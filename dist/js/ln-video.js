function VideoPlayer(src) {
    ...
    let main_ = tempEl.querySelector(".ln-video-container");
    let video = main_.querySelector('video');
    let progressbar = main_.querySelector('.ln-progressbar.vid');
    let volumebar = main_.querySelector('.ln-progressbar.vol');
    let playBtn = main_.querySelector('.ln-btn:has(.ln-play)');
    let fullscreenBtn = main_.querySelector('.ln-btn:has(.ln-fullscreen)');
    let currentTime = main_.querySelector('.ln-time-view.start');
    let duration = main_.querySelector('.ln-time-view.full');
    let muteBtn = main_.querySelector('.ln-btn:has(.ln-volume)');
    let controls = main_.querySelector('.ln-controls');
    let previewTime = main_.querySelector('.ln-progressbar.vid .ln-time-view');
    let rewindBtn = main_.querySelector('.ln-btn:has(.ln-fast-rewind)');
    let forwardBtn = main_.querySelector('.ln-btn:has(.ln-fast-forward)');
